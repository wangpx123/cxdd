...
<body>
	<form action="" method="post" id="initaldata" name="initaldata">
		<table align="center" border="0" width="">
			...
			<tr>
				<td>
					<input type="checkbox" name="box" id="numberRule"
					value="numberRule">号码规则 <input type="checkbox" name="box"
					id="codeManage" value="codeManage">数据词典 <input
					type="checkbox" name="box" id="putawayStrategy"
					value="putawayStrategy">上架策略 <input type="checkbox"
					name="box" id="allocatedStrategy" value="allocatedStrategy">分配策略
