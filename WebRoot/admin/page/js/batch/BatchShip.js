...
//		    { header: "承运人", dataIndex: '', width: 110, sortable: true},
    ...
    initComponent: function(){
		var me = this;
		this.buildStore(basePath + '/batch/doQueryOrdersForShip.action','StoreSoGrid',20);
...
Ext.define('Redm.Batch.Ship',{
	extend: 'Ext.panel.Panel',
    alias : 'widget.batchshipmanager',
    title:'批量发货',
    layout: 'border',
    initComponent: function(){
    	var me = this;
